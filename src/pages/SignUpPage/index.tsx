...
export const SocialButton = ({
  ...
  <button
    className="w-full max-w-xs font-bold shadow-sm rounded-lg py-1  sm:py-2 bg-purple-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-2 xs:mt-3 sm:mt-5"
    onClick={onClick}
  >
