...
const Alert = ({ header, text }: { header: string; text: string }) => {
  return (
      <div
        dir="rtl"
        role="alert"
        className="absolute z-50  rounded-xl border border-gray-100 bg-white p-4 dark:border-gray-800 dark:bg-gray-900"
      >
