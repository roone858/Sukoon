      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {discountedProducts.map((product, index) => (
            <ScrollToTopLink to={`/products/${product.id}`}>
                ...
                <div className="countdown-grid mb-4">
                  <div className="countdown-box">
                    <span className="countdown-value">
                      {String(timers[product.id]?.seconds || 0).padStart(2, '0')}
                    </span>
                    <span className="countdown-label">ثانية</span>
                  </div>
                  <div className="countdown-box">
                    <span className="countdown-value">
                      {String(timers[product.id]?.minutes || 0).padStart(2, '0')}
                    </span>
                    <span className="countdown-label">دقيقة</span>
                  </div>
                  <div className="countdown-box">
                    <span className="countdown-value">
                      {String(timers[product.id]?.hours || 0).padStart(2, '0')}
                    </span>
