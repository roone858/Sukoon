...
const FloatingWhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50  items-center">
      <div className="flex justify-center items-center w-14 h-14 bg-green-500 rounded-full shadow-2xl   cursor-pointer">
        <Link
          to={whatsappUrl}
          target="_blank"
